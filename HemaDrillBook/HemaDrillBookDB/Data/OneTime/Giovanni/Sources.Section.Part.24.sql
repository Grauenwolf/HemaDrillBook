...
BEGIN
    ...
    VALUES
    (6901, 24, NULL, N'History', NULL, 1, 'History'),
    (6902, 24, NULL, N'Weapons and Equipment', NULL, 2, 'Weapons'),
    (6903, 24, NULL, N'General Discussion', NULL, 3, 'General-Discussion'),
    (6904, 24, NULL, N'Misc. Drills and Lessons', NULL, 4, 'Misc');
