...
BEGIN
    ...
    VALUES
    (2901, 17, NULL, N'History', NULL, 1, 'History'),
    (2902, 17, NULL, N'Weapons and Equipment', NULL, 2, 'Weapons'),
    (2903, 17, NULL, N'General Discussion', NULL, 3, 'General-Discussion'),
    (2904, 17, NULL, N'Misc. Drills and Lessons', NULL, 4, 'Misc');
